...
Этот пакет содержит реализацию паттерна Repository для работы с базой данных PostgreSQL. Архитектура основана на Python DAO паттерне, но адаптирована для Go.
